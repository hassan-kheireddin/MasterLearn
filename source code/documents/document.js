...
function addDocument(name, description, readMoreLink) {
    ...
    // Create document header (Document Name)
    ...
    // Create document description (small paragraph)
    ...
    readMoreButton.target = "_blank"; // Opens in a new tab

    // Append all elements to the document container
...
// Example: Adding documents dynamically
